...
L<2.0 Development Source Distribution|download::source/2_0_Development_Source_Distribution>
...
access these packages at L<http://perl.apache.org/dist/win32-bin/ppms/>,
for builds 8xx, and
L<http://perl.apache.org/dist/win32-bin/ppmpackages/>,
for builds 6xx.
...
L<http://perl.apache.org/dist/win32-bin/Perl-5.8-win32-bin/>
