...
makes the constants C<Apache2::FORBIDDEN> and C<Apache2::OK> available
...
=head3 C<Apache2::CONN_KEEPALIVE>
...
=head3 C<Apache2::NOT_IN_VIRTUALHOST>
...
=head3 C<Apache2::NOT_IN_DIRECTORY>
...
=head3 C<Apache2::NOT_IN_LOCATION>
...
=head3 C<Apache2::NOT_IN_DIR_LOC_FILE>
...
=head3 C<Apache2::FTYPE_CONNECTION>
...
=head3 C<Apache2::FTYPE_CONTENT_SET>
...
=head3 C<Apache2::FTYPE_PROTOCOL>
...
=head3 C<Apache2::FTYPE_RESOURCE>
...
=head3 C<Apache2::FTYPE_TRANSCODE>
...
=head3 C<Apache2::HTTP_BAD_GATEWAY>
...
=head3 C<Apache2::HTTP_BAD_REQUEST>
...
=head3 C<Apache2::HTTP_EXPECTATION_FAILED>
...
=head3 C<Apache2::HTTP_FAILED_DEPENDENCY>
...
=head3 C<Apache2::HTTP_FORBIDDEN>
...
=head3 C<Apache2::HTTP_GATEWAY_TIME_OUT>
...
=head3 C<Apache2::HTTP_INSUFFICIENT_STORAGE>
...
=head3 C<Apache2::HTTP_INTERNAL_SERVER_ERROR>
...
=head3 C<Apache2::HTTP_LENGTH_REQUIRED>
...
=head3 C<Apache2::HTTP_METHOD_NOT_ALLOWED>
...
=head3 C<Apache2::HTTP_MOVED_PERMANENTLY>
...
=head3 C<Apache2::HTTP_MOVED_TEMPORARILY>
...
=head3 C<Apache2::HTTP_MULTIPLE_CHOICES>
...
=head3 C<Apache2::HTTP_MULTI_STATUS>
...
=head3 C<Apache2::HTTP_NON_AUTHORITATIVE>
...
=head3 C<Apache2::HTTP_NOT_ACCEPTABLE>
...
=head3 C<Apache2::HTTP_NOT_EXTENDED>
...
=head3 C<Apache2::HTTP_NOT_FOUND>
...
=head3 C<Apache2::HTTP_NOT_IMPLEMENTED>
...
=head3 C<Apache2::HTTP_NOT_MODIFIED>
...
=head3 C<Apache2::HTTP_NO_CONTENT>
...
=head3 C<Apache2::HTTP_PARTIAL_CONTENT>
...
=head3 C<Apache2::HTTP_PAYMENT_REQUIRED>
...
=head3 C<Apache2::HTTP_PRECONDITION_FAILED>
...
=head3 C<Apache2::HTTP_PROCESSING>
...
=head3 C<Apache2::HTTP_PROXY_AUTHENTICATION_REQUIRED>
...
=head3 C<Apache2::HTTP_RANGE_NOT_SATISFIABLE>
...
=head3 C<Apache2::HTTP_REQUEST_ENTITY_TOO_LARGE>
...
=head3 C<Apache2::HTTP_REQUEST_TIME_OUT>
...
=head3 C<Apache2::HTTP_REQUEST_URI_TOO_LARGE>
...
=head3 C<Apache2::HTTP_RESET_CONTENT>
...
=head3 C<Apache2::HTTP_SEE_OTHER>
...
=head3 C<Apache2::HTTP_SERVICE_UNAVAILABLE>
...
=head3 C<Apache2::HTTP_SWITCHING_PROTOCOLS>
...
=head3 C<Apache2::HTTP_TEMPORARY_REDIRECT>
...
=head3 C<Apache2::HTTP_UNAUTHORIZED>
...
=head3 C<Apache2::HTTP_UNPROCESSABLE_ENTITY>
...
=head3 C<Apache2::HTTP_UNSUPPORTED_MEDIA_TYPE>
...
=head3 C<Apache2::HTTP_UPGRADE_REQUIRED>
...
=head3 C<Apache2::HTTP_USE_PROXY>
...
=head3 C<Apache2::HTTP_VARIANT_ALSO_VARIES>
...
=head3 C<Apache2::MODE_EXHAUSTIVE>
...
=head3 C<Apache2::MODE_READBYTES>
...
=head3 C<Apache2::MODE_SPECULATIVE>
...
=head3 C<Apache2::M_BASELINE_CONTROL>
...
=head3 C<Apache2::M_VERSION_CONTROL>
...
=head3 C<Apache2::MPMQ_NOT_SUPPORTED>
...
=head3 C<Apache2::MPMQ_MAX_DAEMON_USED>
...
=head3 C<Apache2::MPMQ_IS_THREADED>
...
=head3 C<Apache2::MPMQ_IS_FORKED>
...
=head3 C<Apache2::MPMQ_HARD_LIMIT_DAEMONS>
...
=head3 C<Apache2::MPMQ_HARD_LIMIT_THREADS>
...
=head3 C<Apache2::MPMQ_MAX_THREADS>
...
=head3 C<Apache2::MPMQ_MIN_SPARE_DAEMONS>
...
=head3 C<Apache2::MPMQ_MIN_SPARE_THREADS>
...
=head3 C<Apache2::MPMQ_MAX_SPARE_DAEMONS>
...
=head3 C<Apache2::MPMQ_MAX_SPARE_THREADS>
...
=head3 C<Apache2::MPMQ_MAX_REQUESTS_DAEMON>
...
=head3 C<Apache2::MPMQ_MAX_DAEMONS>
...
=head3 C<Apache2::OR_ALL>

C<L<Apache2::OR_LIMIT|/C_Apache2__OR_LIMIT_>> | 
C<L<Apache2::OR_OPTIONS|/C_Apache2__OR_OPTIONS_>> | 
C<L<Apache2::OR_FILEINFO|/C_Apache2__OR_FILEINFO_>> | 
C<L<Apache2::OR_AUTHCFG|/C_Apache2__OR_AUTHCFG_>> | 
C<L<Apache2::OR_INDEXES|/C_Apache2__OR_INDEXES_>>
...
=head3 C<Apache2::REMOTE_DOUBLE_REV>
...
=head3 C<Apache2::REMOTE_NOLOOKUP>
...
=head3 C<Apache2::SATISFY_NOSPEC>
...
=head3 C<Apache2::DIR_MAGIC_TYPE>
