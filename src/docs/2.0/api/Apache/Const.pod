...
F<*.conf> inside E<lt>DirectoryE<gt> or E<lt>LocationE<gt>
...
F<*.conf> inside E<lt>DirectoryE<gt> or E<lt>LocationE<gt> and F<.htaccess> when AllowOverride AuthConfig
...
F<*.conf> anywhere and F<.htaccess> when AllowOverride FileInfo
...
F<*.conf> anywhere and F<.htaccess> when AllowOverride Indexes
...
F<*.conf> inside E<lt>DirectoryE<gt> or E<lt>LocationE<gt> and F<.htaccess> when AllowOverride Limit
...
F<*.conf> anywhere and F<.htaccess> when AllowOverride Options
...
F<*.conf> outside E<lt>DirectoryE<gt> or E<lt>LocationE<gt>
