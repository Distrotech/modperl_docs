...
=item arg3: C<$level> (C<L<Apache::LOG_* constant|/LogLevel_Constants>>)

The level of this error message

=item arg4: C<$status> (integer)

The status code from the last command (similar to $! in perl, usually
APR:: status constant)

=item arg5: C<@message> (ARRAY)
...
=item arg1: C<$fname> (C<L<APR::Pool|docs::2.0::api::APR::Pool>>)
