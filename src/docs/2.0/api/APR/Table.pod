...
=item obj: C<$t> (C<L<APR::Table|docs::2.0::api::APR::Table>>)
...
=item obj: C<$p> (C<L<APR::Table|docs::2.0::api::APR::Table>>)
...
=item obj: C<$t_a> (C<L<APR::Table|docs::2.0::api::APR::Table>>)

The table to add the data to.

=item arg1: C<$t_b> (C<L<APR::Table|docs::2.0::api::APR::Table>>)
...
=item obj: C<$t_base> (C<L<APR::Table|docs::2.0::api::APR::Table>>)

The table to add at the end of the new table.

=item arg1: C<$t_overlay> (C<L<APR::Table|docs::2.0::api::APR::Table>>)
