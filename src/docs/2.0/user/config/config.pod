...
See C<L<PerlOpenLogsHandler|docs::2.0::user::handlers::server/PerlOpenLogsHandler>>.

=head2 C<PerlPostConfigHandler>

See C<L<PerlPostConfigHandler|docs::2.0::user::handlers::server/PerlPostConfigHandler>>.

=head2 C<PerlChildInitHandler>

See C<L<PerlChildInitHandler|docs::2.0::user::handlers::server/PerlChildInitHandler>>.

=head2 C<PerlChildExitHandler>

See C<L<PerlChildExitHandler|docs::2.0::user::handlers::server/PerlChildExitHandler>>.
