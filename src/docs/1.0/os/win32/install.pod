...
L<http://theoryx5.uwinnipeg.ca/apache/perl/win32-bin/> - see the file
F<perl-win32-bin.readme> for a description. If you have trouble
fetching the whole file at once, the directory
L<http://theoryx5.uwinnipeg.ca/apache/perl/win32-bin/perl-win32-bin/>
...
L<http://theoryx5.uwinnipeg.ca/apache/perl/win32-bin/ppms/>,
for builds 8xx, and
L<http://theoryx5.uwinnipeg.ca/apache/perl/win32-bin/ppmpackages/>,
for builds 6xx.
