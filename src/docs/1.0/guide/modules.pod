...
For a complete list of modules, see the L<Apache/Perl Modules
|products::apache-modules>.
...
=head1 Apache::Admin::Config - Object oriented access to Apache style config files

C<Apache::Admin::Config> provides an object oriented interface for reading
...
See http://rs.rhapsodyk.net/devel/apache-admin-config/
