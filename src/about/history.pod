...
MacEachern. Together they formed the mod_perl PMC (Project Management
Committee) which is a group of committers to mod_perl who take
responsibility for the long-term direction of the project).  Today,
the PMC consists of:
